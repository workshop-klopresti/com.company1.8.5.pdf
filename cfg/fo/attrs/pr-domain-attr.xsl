...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
    ...
    <xsl:attribute-set name="parmname"> </xsl:attribute-set>
    ...
    <xsl:attribute-set name="plentry"> </xsl:attribute-set>
    ...
    <xsl:attribute-set name="fragment.group"> </xsl:attribute-set>

    <xsl:attribute-set name="syntaxdiagram.group"> </xsl:attribute-set>
