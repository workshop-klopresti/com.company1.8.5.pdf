...
Software obackgr its derivatives. In no event shall Idiom Technologies, Inc.&apos;s
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:attribute-set name="table.title" use-attribute-sets="base-font common.title">
    ...
    <xsl:attribute name="font-family">Table Titles</xsl:attribute>
  </xsl:attribute-set>
  ...
  <xsl:attribute-set name="thead.row" use-attribute-sets="table.frame__sides"> </xsl:attribute-set>
...
<!--  DEFINITION LIST FORMATTING -->
  ...
  <xsl:attribute-set name="dl__paragraph">
  </xsl:attribute-set>
 ...
 <!--  KLL 2016-10-07 definition list formatting for 2-column table output -->
<!-- 02-16-2016 Updated dl margins to line up with choice table-->
  <xsl:attribute-set name="dl">
    <!--DL is a definition list in table format-->
    <xsl:attribute name="width">100%</xsl:attribute>
    <!--  Apache FOP Renderer does not support auto table-layout -->
  ...
  <xsl:attribute-set name="dlentry.dt__content" use-attribute-sets="common.table.body.entry"> </xsl:attribute-set>

  <xsl:attribute-set name="dlentry.dd"> </xsl:attribute-set>

  <!-- Formats definition description text -->
  ...
  <!-- Formatting for the definition term  heading -->
  ...
  <!-- Formatting for the definition description heading -->
  ...
  <xsl:attribute-set name="strow">
    <xsl:attribute name="keep-together.within-page">always</xsl:attribute></xsl:attribute-set>
  ...
  <xsl:attribute-set name="dlentry.dt__content" use-attribute-sets="common.table.body.entry">
