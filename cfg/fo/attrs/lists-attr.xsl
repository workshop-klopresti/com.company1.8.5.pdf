...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:attribute-set name="ul.li__content"> </xsl:attribute-set>
    ...
    <!-- For ordered lists
    text alignment=start acts as left if direction is left-to-right and right if direction is right-to-left.
    text alignment=right aligns decimal points to the right
    -->
    ...
    <xsl:attribute-set name="ol.li__content"> </xsl:attribute-set>

    <!--Simple list-->
    <xsl:attribute-set name="sl" use-attribute-sets="common.block">
        <!-- 'between starts' refers to apace between number/bullet and text     -->
        <xsl:attribute name="provisional-distance-between-starts">0in</xsl:attribute>
        <xsl:attribute name="provisional-label-separation">1mm</xsl:attribute>
    </xsl:attribute-set>
    ...
    <xsl:attribute-set name="sl.sli__content"> </xsl:attribute-set>
