...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="*[contains(@class, ' reference/refbody ')]/*[contains(@class, ' topic/example ')]">
    <fo:block xsl:use-attribute-sets="reference.example">
      <xsl:call-template name="commonattributes"/>
      <xsl:choose>
      ...
      <fo:block xsl:use-attribute-sets="reference.example__content">
