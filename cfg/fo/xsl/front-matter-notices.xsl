<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template name="processTopicNotices">
        <!-- TOMV (2014-11) Update page sequence to notice-sequence (new) and set format to roman numbers -->
...
-->
                        <!-- TOMV: (2014-11) since title block is supressed, the prolg index terms (if any) need to be inserted-->
                        <fo:block>
                            <xsl:call-template name="pullPrologIndexTerms"/>
                        </fo:block>
