        ...
        <xsl:choose>
            <xsl:when
                ...
                <fo:bookmark>
                    ...
                    <!--DITA for Print-->
                    <fo:bookmark-title>
                        <!--	If statement adds chapter number to bookmarks			    Adds-->
            ...
            <xsl:choose>
                ...
                <xsl:otherwise>
                    ...
                    <xsl:choose>
                        ...
                        <xsl:when
                            test="
                                ($ditaVersion >= 1.1) and ($map//*[contains(@class, ' bookmap/toc ')]
                    ...
                    <xsl:if test="//opentopic-index:index.groups//opentopic-index:index.entry">
                        <xsl:choose>
                            ...
                            <xsl:when
                                test="
                                    ($ditaVersion >= 1.1) and ($map//*[contains(@class, ' bookmap/indexlist ')]
                                    or /*[contains(@class, ' map/map ')][not(contains(@class, ' bookmap/bookmap '))])">
