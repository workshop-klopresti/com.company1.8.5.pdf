...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  exclude-result-prefixes="opentopic exsl opentopic-index dita2xslfo ot-placeholder" version="2.0">
  ...
  <xsl:template match="ot-placeholder:tablelist">
    <xsl:if test="//*[contains(@class, ' topic/table ')]/*[contains(@class, ' topic/title ' )]">
      ...
      <fo:page-sequence master-reference="toc-sequence" format="1"
  ...
  <xsl:template
    match="*[contains (@class, ' topic/table ')][child::*[contains(@class, ' topic/title ' )]]"
    mode="list.of.tables">
              ...
              <xsl:with-param name="theParameters">
                <number>
                  ...
                  <xsl:variable name="tableNumber">
                    <xsl:number format="1"
                      value="count($tableset/*[@id = $id]/preceding-sibling::*) + 1"/>
                  </xsl:variable>
                  <!--DITA for Print-->
  ...
  <xsl:template
    match="*[contains (@class, ' topic/fig ')][child::*[contains(@class, ' topic/title ' )]]"
    mode="list.of.figures">
              ...
              <xsl:with-param name="theParameters">
                <number>
                  ...
                  <xsl:variable name="figureNumber">
                    <xsl:number format="1"
                      value="count($figureset/*[@id = $id]/preceding-sibling::*) + 1"/>
                  </xsl:variable>
                  <!--DITA for Print-->
                  <xsl:call-template name="getChapterPrefix"/>
                  <xsl:text>-</xsl:text>
